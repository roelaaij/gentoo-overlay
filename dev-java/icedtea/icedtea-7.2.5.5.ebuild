...
java_prepare() {
	...
	cp "${FILESDIR}/dtrace-gcc5.patch" "${S}/patches"
	cp "${FILESDIR}/missing-template-instantiation.patch" "${S}/patches"
...
src_compile() {
	...
	DISTRIBUTION_PATCHES="patches/missing-template-instantiation.patch patches/dtrace-gcc5.patch" emake
}
