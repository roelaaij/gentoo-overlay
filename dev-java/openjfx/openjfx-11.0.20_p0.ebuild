...
SRC_URI="https://github.com/openjdk/jfx${SLOT}u/archive/refs/tags/${MY_PV}.tar.gz -> ${P}.tar.gz
...
PATCHES=(
	"${FILESDIR}"/11/0001-disable-buildSrc-tests.patch
	"${FILESDIR}"/11/0002-glibc-compatibility.patch
	"${FILESDIR}"/11/0003-respect-user-cflags.patch
	"${FILESDIR}"/11/0004-use-system-swt-jar.patch
	"${FILESDIR}"/11/0005-wno-error.patch
	"${FILESDIR}"/11/0006-don-t-force-msse2.patch
	"${FILESDIR}"/11/0007-disable-architecture-verification.patch
)

S_PV="${PV/_p/-}"
S="${WORKDIR}/jfx${SLOT}u-${S_PV}"
