...
SRC_URI="
	...
	https://github.com/astral-sh/ruff/releases/download/${RUFF_PV}/source.tar.gz -> ruff-${RUFF_PV}.tar.gz
"
...
src_unpack() {
	...
	rm -r ${S}/ruff || die
	mv ${WORKDIR}/ruff-${RUFF_PV} ${S}/ruff || die
}
...
src_prepare() {
	...
	# to mirror.
	pushd ruff/crates >/dev/null || die
	rm -r ruff{,_{benchmark,dev,server}} ruff_python_*_integration_tests ty_completion_eval *_wasm || die
	rm ruff_annotate_snippets/tests/examples.rs || die
