...
SRC_URI="
	http://foundry.supelec.fr/frs/download.php/file/15762/${MY_P}-source.tar.bz2
	http://foundry.supelec.fr/frs/download.php/file/15763/${MY_P}-doc.tar.bz2"
...
src_prepare() {
	epatch ${FILESDIR}/includes-${PV}.patch
