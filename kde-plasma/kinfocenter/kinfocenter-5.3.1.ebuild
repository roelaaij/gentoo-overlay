...
# $Header: /var/cvsroot/gentoo-x86/kde-plasma/kinfocenter/kinfocenter-5.3.1.ebuild,v 1.2 2015/06/11 16:11:21 johu Exp $
...
COMMON_DEPEND="
	...
	|| ( >=dev-qt/qtgui-5.4.2 <dev-qt/qtgui-5.4.2:5[opengl(+)] )
	dev-qt/qtwidgets:5
	gles? (
