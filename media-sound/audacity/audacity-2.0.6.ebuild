...
SRC_URI="http://www.fosshub.com/Audacity.html/${MY_T}.tar.xz"
...
COMMON_DEPEND="x11-libs/wxGTK:3.0[X]
	>=app-arch/zip-2.3
...
src_prepare() {
	epatch "${FILESDIR}"/${P}-with-wxWidgets-3.0.patch
	epatch "${FILESDIR}"/lib-src-makefile-am.patch
