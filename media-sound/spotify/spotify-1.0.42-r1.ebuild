...
SRC_URI="amd64? ( ${SRC_BASE}${PN}-client_${PV}.151.g19de0aa6-74_amd64.deb )
	x86? ( ${SRC_BASE}${PN}-client_${PV}.151.g19de0aa6-27_i386.deb )"
LICENSE="Spotify"
SLOT="0"
KEYWORDS="amd64 x86"
...
RDEPEND="
	...
	media-libs/mesa
	|| ( net-misc/curl[ssl,curl_ssl_openssl] net-misc/curl[ssl,curl_ssl_libressl] )
	net-print/cups[ssl]
	x11-libs/gtk+:2
