...
src_install() {
	...
	rm "${ED}"/usr/share/kodi/addons/skin.estuary/fonts/Lato-* || die
	dosym /usr/share/fonts/lato/Lato-Regular.ttf \
		/usr/share/kodi/addons/skin.estuary/fonts/Lato-Regular.ttf
	dosym /usr/share/fonts/lato/Lato-Bold.ttf \
		/usr/share/kodi/addons/skin.estuary/fonts/Lato-Bold.ttf
