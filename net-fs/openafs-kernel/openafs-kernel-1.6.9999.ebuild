...
inherit autotools eutils multilib linux-mod versionator toolchain-funcs git-r3

MY_P2="openafs-1.6.10"
PVER="1"

DESCRIPTION="The OpenAFS distributed file system kernel module"
HOMEPAGE="http://www.openafs.org/"
# We always d/l the doc tarball as man pages are not USE=doc material
SRC_URI="mirror://gentoo/${MY_P2}-patches-${PVER}.tar.bz2"

EGIT_REPO_URI="git://git.openafs.org/openafs.git"
EGIT_BRANCH="openafs-stable-1_6_x"
