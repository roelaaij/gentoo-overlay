...
SRC_URI="https://github.com/ROCm/rocm-libraries/releases/download/rocm-${PV}/rocwmma.tar.gz -> rocwmma-${PV}.tar.gz"
S="${WORKDIR}/rocwmma"
...
PATCHES=(
	...
	"${FILESDIR}"/${PN}-7.2.0-add-support-for-gfx1103-phoenix.patch
)
