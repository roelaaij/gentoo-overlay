...
RDEPEND="
	>=dev-qt/qtconcurrent-5.7:5
	>=dev-qt/qtcore-5.7:5
	>=dev-qt/qtdeclarative-5.7:5[widgets]
	>=dev-qt/qtgui-5.7:5
	>=dev-qt/qtnetwork-5.7:5[ssl]
	>=dev-qt/qtprintsupport-5.7:5
	>=dev-qt/qtsql-5.7:5[sqlite]
	>=dev-qt/qtwebchannel-5.7:5
	>=dev-qt/qtwebengine-5.7:5[widgets]
	>=dev-qt/qtwidgets-5.7:5
	>=dev-qt/qtx11extras-5.7:5
	x11-libs/libxcb:=
	dbus? ( >=dev-qt/qtdbus-5.7:5 )
