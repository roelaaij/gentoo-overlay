...
# $Header: /var/cvsroot/gentoo-x86/x11-base/xorg-server/xorg-server-1.16.0.ebuild,v 1.2 2014/07/26 09:31:38 ssuominen Exp $
...
IUSE="${IUSE_SERVERS} glamor ipv6 minimal nptl selinux +suid systemd tslib +udev unwind wayland dri3"
