...
SRC_URI="${NV_URI}Linux-x86_64/${PV}/${AMD64_NV_PACKAGE}.run
"
...
IUSE="compat +driver gtk3 kernel_FreeBSD kernel_linux +kms +libglvnd multilib static-libs uvm wayland +X"
