...
# $Header: /var/cvsroot/gentoo-x86/x11-libs/libva-intel-driver/libva-intel-driver-1.6.0.ebuild,v 1.1 2015/07/06 14:39:19 aballier Exp $
...
PATCHES=(
	...
	"${FILESDIR}"/makefile_wayland.patch
)
